...
//        boolean s=checkInclusion("ADOBECODEBANC","DOBC");
        boolean s=checkInclusion("eidboaoo","bao");
        System.out.println(s);
    }
    public static boolean checkInclusion(String s, @NotNull String t){
